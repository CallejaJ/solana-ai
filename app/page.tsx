...
export default function Home() {
  ...
  return (
    <SidebarProvider defaultOpen={false}>
      ...
      />
      <SidebarInset>
        <div className="flex h-svh min-w-0 flex-col overflow-x-hidden bg-background">
          <SolanaHeader network={network} onNetworkChange={setNetwork} />

          <main className="flex flex-1 flex-col overflow-hidden">
            {uniqueMessages.length === 0 ? (
              <div className="flex flex-1 flex-col items-center justify-center gap-6 overflow-y-auto px-4 pb-8 pt-36 sm:gap-10 sm:px-6 sm:py-10">
